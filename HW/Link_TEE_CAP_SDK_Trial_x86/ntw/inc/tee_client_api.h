 ...
 * Constants
 */
#define TEEC_CONFIG_SHAREDMEM_MAX_SIZE (0x00400000)     /* 4M */
...
/**
 * Initializes a new TEE context, forming a connection between this client
 * application and the TEE identified by the string identifier name.
 *
 * @name[in]     A zero-terminated string identifying the TEE to connect to.
 *               If name is set to NULL, the default TEE is connected to.
 * @context[out] The context structure which is to be initialized.
 */
TEEC_Result TEEC_InitializeContext(const char *name, TEEC_Context *context);

/**
 * Finalizes an initialized TEE context, closing the connection between the
 * client application and the TEE.
 *
 * This function must only be called when all sessions related to this TEE context
 * have been closed and all shared memory blocks have been released.
 *
 * @context[in]  An initialized context structure which is to be finalized.
 */
