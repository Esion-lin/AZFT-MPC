...
public:
	...
	uint32_t input_data(uint8_t* label, uint32_t lab_len, uint8_t* tru_in, uint32_t len, uint8_t* tru_data_in,uint32_t &data_len_in, uint8_t* tru_mac_in, uint32_t &mac_len_in);
	...
	/*run protocol*/
	uint32_t operation(uint8_t* protocol, uint32_t protocol_len, uint8_t* mac, uint32_t mac_len, uint8_t* label, uint32_t lab_len, uint8_t* data_in, uint32_t data_len, uint8_t* mac_data, uint32_t mac_data_len);
